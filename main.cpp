...
#define MESH_NAME "models/monkeyhead_smooth.dae"
/*----------------------------------------------------------------------------
----------------------------------------------------------------------------*/
...
void display() {
	...
	model = glm::rotate(model, glm::radians(rotate_y), glm::vec3(0,0,1));
	...
	glm::mat4 modelChild = glm::mat4(1.0f);
	modelChild = glm::rotate(modelChild, glm::radians(180.0f), glm::vec3(0,0,1));
	modelChild = glm::rotate(modelChild, glm::radians(rotate_y),glm::vec3(0,1,0));
	...
	glUniformMatrix4fv(matrix_location, 1, GL_FALSE, glm::value_ptr(modelChild));
	glDrawArrays(GL_TRIANGLES, 0, mesh_data.mPointCount);
